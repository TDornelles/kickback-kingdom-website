...
try
{
    ...
    $response = null;
    $response_code = TransactionService::get_transactions_for_account($sessionAccount, $request_contents_json, $response);
    if ( $response_code !== 0 ) {
...
catch( \Throwable $e )
{
    ...
    $response = new Response(false,
        'Failed to retrieve transactions for account: ' . ThrowableOverrides::message($e),
        $e->__toString());
}
finally {
    Endpoint::end();
