...
try
{
    ...
    $response_code = $paymentController->initiateCheckout($sessionAccount, $request_contents_json, $response);
    if ( $response_code !== 0 ) {
...
catch( \Throwable $e )
{
    ...
    $response = new Response(false,
        'Failed to initiate checkout: ' . ThrowableOverrides::message($e),
        null);
}
finally {
    Endpoint::end();
